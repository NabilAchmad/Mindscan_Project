...
export default function StudentConsultationListScreen({ navigation }: any) {
  ...
  const renderConsultation = ({ item }: { item: any }) => (
    <TouchableOpacity 
      ...
      className="bg-white p-4 rounded-xl mb-4 border border-gray-100 shadow-sm flex-row items-center justify-between"
    >
      <View>
        ...
        <Text className="text-sm text-blue-600 font-medium mt-1">Konsultasi Aktif</Text>
      </View>
